...
PROCESSOR_DIR="/users/PNS0496/badhon19/nist_am/IN718_singletrack/processor1"
VTK_DIR="/users/PNS0496/badhon19/nist_am/IN718_singletrack/testing/vtk"
...
test_environment() {
    ...
    # Check recon_test
    recon_dir="/users/PNS0496/badhon19/nist_am/IN718_singletrack"
        ...
        if [ -d "$PROCESSOR_DIR" ]; then
            ...
            for dir in "${new_dirs[@]}"; do
                if ! grep -q "^$dir$" "$processed_log"; then
                    ...
                    cd "/users/PNS0496/badhon19/nist_am/IN718_singletrack"
